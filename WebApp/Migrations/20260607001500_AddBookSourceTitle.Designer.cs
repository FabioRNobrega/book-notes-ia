...
namespace WebApp.Migrations
{
    ...
    [Migration("20260607001500_AddBookSourceTitle")]
    partial class AddBookSourceTitle
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApp.Models.Book", b =>
                {
                    ...
                    b.HasIndex("UserId", "NormalizedTitle", "NormalizedAuthor")
                        .IsUnique();
            ...
            modelBuilder.Entity("WebApp.Models.BookNote", b =>
                {
                    ...
                    b.Property<DateTime>("ClippedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("WebApp.Models.UserProfile", b =>
                {
                    ...
                    b.Property<string>("AgentProfileCompact")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<int>("AgentProfileVersion")
                        .HasColumnType("integer");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<JsonDocument>("DislikedGenres")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<JsonDocument>("LearningStyle")
                        .HasColumnType("jsonb");

                    b.Property<JsonDocument>("LovedGenres")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<JsonDocument>("ReadingLanguages")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("WebApp.Models.BookNoteEmbedding", b =>
                {
                    ...
                    b.HasOne("WebApp.Models.BookNote", "BookNote")
                        .WithMany()
