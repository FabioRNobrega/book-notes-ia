...
| Phase 12 | P2 | Tune semantic lookup threshold and add user-facing diagnostics for unresolved books. | ⚠️ TODO: Create a dedicated `YYYYMMDDHHMMSS-feature-name` folder in `Specs/`. | Small/Medium | Current threshold is `0.5`; real usage should validate it against imported libraries and aliases. |
